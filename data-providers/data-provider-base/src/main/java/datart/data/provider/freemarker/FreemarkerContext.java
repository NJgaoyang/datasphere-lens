...
public class FreemarkerContext {
    ...
    static {
        ...
        // Security: disable ?new built-in to prevent arbitrary Java object instantiation (CVE-2025-70830)
        conf.setNewBuiltinClassResolver(TemplateClassResolver.SAFER_RESOLVER);
        // Security: disable ?api built-in to prevent exposing Java API of template objects
        conf.setAPIBuiltinEnabled(false);
        // Security: disable loading of TLD files to prevent JSP taglib injection
        try {
            conf.setSetting("auto_import", "");
            conf.setSetting("auto_include", "");
