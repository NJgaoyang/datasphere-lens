...
public class DownloadController extends BaseController {
    ...
    @Operation(summary = "synchronous streaming download (generates file and streams directly)")
    @PostMapping(value = "/sync")
    public void syncDownload(@RequestBody @Validated DownloadCreateParam createParam,
                             HttpServletResponse response) throws Exception {
        downloadService.syncDownload(createParam, response);
    }
