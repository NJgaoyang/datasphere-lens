...
public interface DownloadService extends BaseCRUDService<Download, DownloadMapperExt> {
    ...
    /**
     * Synchronous streaming download: generate file and stream directly to response.
     * No async task, no polling needed.
     */
    void syncDownload(DownloadCreateParam downloadCreateParam, HttpServletResponse response) throws Exception;
