...
export const selectModuleAccessMap = createSelector(
  [selectDomain],
  mainState => mainState.moduleAccessMap,
);

export const selectHideInNav = createSelector(
  [selectDomain],
  mainState => mainState.hideInNav,
);
